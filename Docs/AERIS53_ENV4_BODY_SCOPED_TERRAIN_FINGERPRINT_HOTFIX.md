...
- build/install;
- first runtime evidence check for the body-scope self-test and audit fields;
- second unchanged-GameData runtime check requiring all observed environments to match
  and zero environment transitions.
