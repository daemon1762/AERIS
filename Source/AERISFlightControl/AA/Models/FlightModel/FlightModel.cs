...
namespace AtmosphereAutopilot
{
    ...
    {
        // AERIS: retain AA's live flight-model updates, but allow the optional background
        // ANN/lift trainer workers to be disabled for performance-sensitive installs.
        public static bool BackgroundTrainingEnabled = false;
        bool backgroundTrainingRegistered = false;

        // v0.5.7 observation-only freshness stamp for AERIS-AA FlightState crosscheck.
        // It does not change any AA state estimate or control law.
        public float LastModelUpdateFixedTime { get; private set; } = -1f;
        public int ModelUpdateSequence { get; private set; } = 0;
        ...
        protected override void OnActivate()
        {
            ...
            if (BackgroundTrainingEnabled)
            {
                ...
                backgroundTrainingRegistered = true;
            }
        }
        ...
        protected override void OnDeactivate()
        {
            vessel.OnPreAutopilotUpdate -= new FlightInputCallback(OnPreAutopilot);
            vessel.OnPostAutopilotUpdate -= new FlightInputCallback(OnPostAutopilot);
            if (backgroundTrainingRegistered)
            {
                ...
                backgroundTrainingRegistered = false;
            }
            return_gimbals();
            sequential_dt = false;
        ...
        {
            LastModelUpdateFixedTime = Time.fixedTime;
            ModelUpdateSequence++;
