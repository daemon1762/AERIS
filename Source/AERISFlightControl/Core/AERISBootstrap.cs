...
namespace AERISFlightControl.Core
{
 [KSPAddon(KSPAddon.Startup.MainMenu, true)] public sealed class AERISBootstrap : MonoBehaviour
 {
  ...
  internal AERISApproachRegistry Approaches { get; private set; }
  ...
  static string RuntimeAssemblySha256(){
   try{
  ...
  void SyncRuntimeRevisions(){
   if(Performance==null||Airfields==null)return;
