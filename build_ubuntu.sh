...
# CP3 Gate 5 is an integration-acceptance-only checkpoint. Production runtime logic
# remains frozen at the accepted Gate 4C implementation; this runner verifies the
# complete CP3 boundary before native compilation.
PYTHONDONTWRITEBYTECODE=1 python3 "$ROOT/Tools/run_v01800_cp3_gate5_acceptance.py"
cd "$SRC"
