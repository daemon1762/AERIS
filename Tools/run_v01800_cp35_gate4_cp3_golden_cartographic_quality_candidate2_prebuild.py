...
suites=[
 ('Gate 4 CP3 Golden cartographic quality Candidate 2','selftest_v01800_cp35_gate4_cp3_golden_cartographic_quality_candidate2.py'),
...
print('\n[v0.18.0.0 CP3.5 Gate 4 CP3 Golden Cartographic Quality Candidate 2 PREBUILD] %d/%d lightweight suites PASS' % (len(suites),len(suites)))
