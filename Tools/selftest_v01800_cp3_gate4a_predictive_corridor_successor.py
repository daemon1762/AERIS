...
suite = CheckSuite("v0.18.0.0 CP3 Gate 4A Predictive Corridor successor")
...
runner = read(ROOT / "Tools/run_v01800_cp3_gate4a_acceptance.py")
...
suite.check(
            'UiCheckpoint = "DEV CP3 GATE 4A — RENDER-READY HEIGHT FIELD & GPU-ONLY FAR PRESENTATION — COMPILE HOTFIX 2"' in generated and
            'UiCheckpoint = "DEV CP3 GATE 4A — RENDER-READY HEIGHT FIELD & GPU-ONLY FAR PRESENTATION — COMPILE HOTFIX 2"' in build,
            "generated/build tab version names Gate 4A")
...
suite.check("selftest_v01800_cp3_gate4a_predictive_corridor_successor.py" in runner,
            "active Gate 4A runner executes the corridor successor")
suite.check("run_v01800_cp3_gate4a_acceptance.py" in build,
            "build entrypoint runs Gate 4A acceptance")
