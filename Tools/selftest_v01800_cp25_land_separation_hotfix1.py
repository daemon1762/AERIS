...
suite = CheckSuite("v0.18.0.0 CP2.5 LAND separation hotfix 1")
...
plan_end = tiles.find("void AddPointWithFallback", plan_start)
plan = tiles[plan_start:plan_end]
suite.check(plan.count("AERISTerrainTileLod.Land") == 2 and
            plan.count("AERISTerrainRequestLane.Landing") == 2,
            "runtime LAND requests are limited to the armed runway pair")
