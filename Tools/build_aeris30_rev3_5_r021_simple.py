...
PREFIX = '[AERIS30 REV3.5 R021 SIMPLE BUILD]'
R020 = 'AERIS29_REV3_5_SALBUTAMOL_SULFATE_R020_VISIBLE_AUTHORITY_BASELINE_STABILITY'
R021 = 'AERIS30_REV3_5_SALBUTAMOL_SULFATE_R021_EXACT_VISIBLE_UPSTREAM_PRIORITY'
...
parser = argparse.ArgumentParser(description=(
    'Simplified AERIS R021 development build. Directly compiles the current materialized '
    'C# source and installs the DLL. No applicators, historical replay, selftests, clean, '
    'reset, stash, or lineage reconstruction.'))
...
source_text = renderer.read_text(encoding='utf-8') + '\n' + tile_system.read_text(encoding='utf-8')
if R021 in source_text:
    source_revision = R021
    source_stage = 'R021'
elif R020 in source_text:
    source_revision = R020
    source_stage = 'R020_BASELINE'
else:
    raise SystemExit(PREFIX + ' FAIL: neither R020 baseline nor R021 marker found')
...
identity = (
    'build_mode=AERIS30_R021_SIMPLIFIED_DEVELOPMENT\n'
