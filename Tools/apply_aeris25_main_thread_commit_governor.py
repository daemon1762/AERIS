...
# Compile hotfix for Phase6_001 trees generated by the first applicator revision.
# Stopwatch.Elapsed.TotalMilliseconds is available directly on Mono/.NET and avoids
# depending on an undefined local ElapsedMilliseconds helper.
elapsed_old = 'double elapsedMilliseconds = ElapsedMilliseconds(mainThreadCommitStopwatch);'
elapsed_new = 'double elapsedMilliseconds = mainThreadCommitStopwatch.Elapsed.TotalMilliseconds;'
renderer, c5 = replace_once(renderer, elapsed_old, elapsed_new, 'Stopwatch elapsed compile path')
...
renderer, c6 = replace_once(renderer, telemetry_old, telemetry_new, 'runtime telemetry')
