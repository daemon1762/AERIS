...
suites=[
 ('CP3.75 Candidate6 high-density coastline preload','selftest_v01800_cp375_candidate6_high_density_coastline_preload.py'),
...
print('\n[v0.18.0.0 CP3.75 Candidate6 PREBUILD] %d/%d suites PASS' % (len(suites),len(suites)))
