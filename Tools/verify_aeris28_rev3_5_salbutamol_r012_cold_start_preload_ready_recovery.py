...
checks = [
    ...
    ('DrawCleanBackground(plot);' in nav[nav.find('if (solidBodyColdInit)'):nav.find('AERISTerrainGpuDrawState gpuState', nav.find('if (solidBodyColdInit)'))],
     'cold-init alone overwrites standby with clean black background'),
    ('new Color(0.025f, 0.145f, 0.285f, 1f)' in nav,
     'ordinary historical blue standby remains present'),
