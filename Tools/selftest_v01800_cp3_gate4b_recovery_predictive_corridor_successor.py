...
suite = CheckSuite("v0.18.0.0 CP3 Gate 4B Predictive Corridor successor")
...
runner = read(ROOT / "Tools/run_v01800_cp3_gate4b_recovery_acceptance.py")
...
suite.check(
            'UiCheckpoint = "DEV CP3 GATE 4B — ATTR PRESENTATION RECOVERY HOTFIX 1"' in generated and
            'UiCheckpoint = "DEV CP3 GATE 4B — ATTR PRESENTATION RECOVERY HOTFIX 1"' in build,
            "generated/build tab version names Gate 4B recovery hotfix")
...
suite.check("selftest_v01800_cp3_gate4b_recovery_predictive_corridor_successor.py" in runner,
            "active Gate 4B runner executes the corridor successor")
suite.check("run_v01800_cp3_gate4b_recovery_acceptance.py" in build,
            "build entrypoint runs Gate 4B acceptance")
