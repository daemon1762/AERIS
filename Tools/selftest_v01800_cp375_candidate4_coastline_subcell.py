...
print('[AERIS] CP3.75 Candidate4 coastline sub-cell interpolation / line cache accounting static test')
...
identity='DEV CP3.75 — COASTLINE SUB-CELL INTERPOLATION / LINE CACHE ACCOUNTING CANDIDATE 4'
check(identity in version,'Candidate4 generated identity')
check('DEV CP3.75 COASTLINE SUB-CELL INTERPOLATION LINE CACHE ACCOUNTING CANDIDATE 4' in build,
      'Candidate4 build identity')
check('CP3.75 Coastline Sub-Cell Interpolation Line Cache Accounting Candidate 4' in avc,
      'Candidate4 AVC identity')
check('run_v01800_cp375_candidate4_prebuild.py' in build,
      'build entrypoint uses Candidate4 prebuild')
...
if failures:
    print('[AERIS] CP3.75 Candidate4 static authority FAIL: %d failure(s)' % failures)
    raise SystemExit(1)
print('[AERIS] CP3.75 Candidate4 static authority PASS')
