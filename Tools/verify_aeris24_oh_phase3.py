...
checks = [
    ...
    ('internal const string Revision = "OH_PHASE3_005";' in M, "Phase 3 ND reload snapshot hotfix revision"),
    ...
    ('oh_gpu_vertex_requested=' in R and 'oh_gpu_vertex_projection=' in R and
     ...
     'oh_nd_reload_snapshot=' in R,
     "GPU requested/effective + black reload snapshot telemetry"),
