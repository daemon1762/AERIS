...
ck(('internal const string Revision = "OH_PHASE4_004";' in M) or
   ...
   'ATROPINE revision is rev004 or approved rev005/rev006 descendant')
...
ck((('REV004 TEMPORAL FOUNDATION OVERSCAN' in U) or
    ...
    ('REV006 RENDERABLE ENTRY GATE' in U)) and
   'verify_aeris25_temporal_foundation_overscan_hotfix.py' in U,
   'build identity exposes rev004 or approved rev005/rev006 descendant and enforces overscan verifier')
