...
ck(('internal const string Revision = "OH_PHASE4_004";' in M) or
   ...
   'ATROPINE revision is rev004 or approved rev005/rev006/rev007 descendant')
...
ck((('REV004 TEMPORAL FOUNDATION OVERSCAN' in U) or
   ...
   'build identity exposes rev004 or approved rev005/rev006/rev007 descendant and enforces overscan verifier')
