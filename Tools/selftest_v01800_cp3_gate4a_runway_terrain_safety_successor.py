...
suite = CheckSuite("v0.18.0.0 CP3 Gate 4A runway/terrain safety successor")
...
suite.check("AutomaticGpuCapabilityAvailable" in renderer and
            "GPU presentation unavailable" in renderer and
            "CPU terrain presentation is disabled" in renderer,
            "GPU AUTO fails closed without restoring CPU terrain presentation")
