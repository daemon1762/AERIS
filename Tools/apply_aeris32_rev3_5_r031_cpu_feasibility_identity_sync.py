...
if not VERSION.is_file():
    raise SystemExit('R031 CPU feasibility generated build version missing')
text = VERSION.read_text()
if MARKER not in text:
    raise SystemExit('R031 CPU feasibility build identity missing before sync')
...
print('PASS: R031 CPU feasibility build identity synchronized')
