...
suites=[
 ('CP3.75 Candidate3 coastline/contour path unification','selftest_v01800_cp375_candidate3_coastline_unification.py'),
...
print('\n[v0.18.0.0 CP3.75 Candidate3 PREBUILD] %d/%d suites PASS' % (len(suites),len(suites)))
