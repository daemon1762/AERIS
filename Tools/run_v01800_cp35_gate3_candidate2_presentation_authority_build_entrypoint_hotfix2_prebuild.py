...
print('\n[v0.18.0.0 CP3.5 Gate 3 Candidate 2 Presentation Authority Hotfix 1 Build Entrypoint Hotfix 2 PREBUILD] %d/%d lightweight suites PASS' % (len(suites),len(suites)))
