...
suites=[
 ('CP3.75 Candidate4 coastline sub-cell interpolation / line cache accounting','selftest_v01800_cp375_candidate4_coastline_subcell.py'),
...
print('\n[v0.18.0.0 CP3.75 Candidate4 PREBUILD] %d/%d suites PASS' % (len(suites),len(suites)))
