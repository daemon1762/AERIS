...
PREFIX = '[AERIS30 REV3.5 R024 SIMPLE BUILD]'
...
parser = argparse.ArgumentParser(description=(
    'Simplified AERIS R024 development build. Directly compiles the current C# source '
...
identity = (
    'build_mode=AERIS30_R024_SIMPLIFIED_DEVELOPMENT\n'
