...
PREFIX = '[AERIS27 OH REV3.5 SALBUTAMOL SULFATE R006 HF3 RUNTIME]'
...
parser = argparse.ArgumentParser(
    description='Prepare/install AERIS27 REV3.5 R006 Hotfix3 Complete Coverage Contract Repair. Complete 7x7 Preview terrain remains authoritative while 33x33 Final refinement is partial; only a complete Quality100 Final may replace it. R006 managed-buffer recovery and HF1/HF2 teardown safety remain unchanged.')
...
checks = [
    ...
    (marker_in_bytes(dll, 'hf3_preserve=') and
     ...
     'DLL embeds HF3 monotonic-authority telemetry'),
...
print(CYAN + 'HF3 ACTIVE:' + RESET + ' complete terrain authority is monotonic: complete Preview -> complete Final only.')
print(MAGENTA + 'HF3 OBSERVERS:' + RESET + ' hf3_preserve / hf3_retry / hf3_worst_q in CP3 telemetry.')
print(YELLOW + 'HF3 FROZEN:' + RESET + ' no quality reduction; no FoundationComplete relaxation; 10Hz/160km/publication/worker-count semantics unchanged.')
