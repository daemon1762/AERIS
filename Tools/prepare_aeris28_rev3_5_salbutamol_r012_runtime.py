...
PREFIX = '[AERIS28 REV3.5 SALBUTAMOL SULFATE R012 RUNTIME]'
...
p=argparse.ArgumentParser(description='Reconstruct R010 formal runtime, retain R011 observer, overlay R012 cold-start/preload-ready recovery, verify, build and install.')
