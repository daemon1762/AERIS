...
print('[AERIS] CP3.75 Candidate2 runtime stabilization/settings consolidation static test')
...
identity='DEV CP3.75 — ND RUNTIME STABILIZATION / SETTINGS CONSOLIDATION CANDIDATE 2'
check(identity in version,'Candidate2 generated identity')
check('DEV CP3.75 ND RUNTIME STABILIZATION SETTINGS CONSOLIDATION CANDIDATE 2' in build,
      'Candidate2 build identity')
check('CP3.75 ND Runtime Stabilization Settings Consolidation Candidate 2' in avc,
      'Candidate2 AVC identity')
check('run_v01800_cp375_candidate2_prebuild.py' in build,
      'build entrypoint uses Candidate2 prebuild')
...
if failures:
    print('[AERIS] CP3.75 Candidate2 static authority FAIL: %d failure(s)' % failures)
    raise SystemExit(1)
print('[AERIS] CP3.75 Candidate2 static authority PASS')
