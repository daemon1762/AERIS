...
PREFIX = '[AERIS30 REV3.5 R022 SIMPLE BUILD]'
...
parser = argparse.ArgumentParser(description=(
    'Simplified AERIS R022 development build. Directly compiles the current C# source '
...
if R022 in source_text:
    source_revision = R022
    source_stage = 'R022'
elif R021 in source_text:
    source_revision = R021
    source_stage = 'R021_BASELINE'
else:
    raise SystemExit(PREFIX + ' FAIL: neither R021 baseline nor R022 marker found')
...
identity = (
    'build_mode=AERIS30_R022_SIMPLIFIED_DEVELOPMENT\n'
