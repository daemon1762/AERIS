...
suite = CheckSuite("v0.18.0.0 CP3 Gate 4A Alignment Diagnostic successor")
...
suite.check("lastVisualCoverageFraction" in renderer and
            "lastBackFoundationCoverage" in renderer and
            "lastVisualCoverageFraction = 1f" in renderer,
            "complete FRONT presentation is separated from BACK FAR readiness")
