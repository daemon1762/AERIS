...
suites=[
 ('CP3.75 Candidate5 ND range consolidation / RG sea contrast','selftest_v01800_cp375_candidate5_range_rg_sea.py'),
...
print('\n[v0.18.0.0 CP3.75 Candidate5 PREBUILD] %d/%d suites PASS' % (len(suites),len(suites)))
