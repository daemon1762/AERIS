...
tests = [
    "verify_v01708_static.py",
    "verify_v01708_build_entrypoint.py",
    ...
    "selftest_v01704_cache_roundtrip_determinism.py",
    "selftest_v01707_submetre_provider_frame_cache.py",
    "selftest_v01708_failure_hint_identity_compaction.py",
