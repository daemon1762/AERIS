...
# Gate 4B Recovery Hotfix 1 supersedes rejected Gate 4B presentation-state checks while
...
tests = [
    "selftest_v01800_cp3_gate4b_attr_presentation_recovery_hotfix1.py",
    "selftest_v01800_cp3_gate4b_recovery_predictive_corridor_successor.py",
...
print("\n[v0.18.0.0 CP3 Gate 4B ATTR Presentation Recovery Hotfix 1] " +
