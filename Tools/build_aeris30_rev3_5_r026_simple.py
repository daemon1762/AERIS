...
PREFIX = '[AERIS30 REV3.5 R026 SIMPLE BUILD]'
...
R026 = 'AERIS30_REV3_5_SALBUTAMOL_SULFATE_R026_EXACT_VISIBLE_COMMIT_DRAIN_ACCELERATION'
...
parser = argparse.ArgumentParser(description=(
    'Simplified AERIS R026 development build. Directly compiles the current C# source '
...
if R026 in source_text and R025 in observer_text:
    source_revision = R026
    source_stage = 'R026'
elif R025 in observer_text and R024 in source_text:
    source_revision = R025
    source_stage = 'R025_BASELINE'
    ...
    raise SystemExit(PREFIX + ' FAIL: expected R024/R025/R026 source markers not found')
...
identity = (
    'build_mode=AERIS30_R026_SIMPLIFIED_DEVELOPMENT\n'
