...
suites=[
 ('CP3.75 Candidate2 runtime stabilization/settings consolidation','selftest_v01800_cp375_candidate2_runtime_stabilization.py'),
...
print('\n[v0.18.0.0 CP3.75 Candidate2 PREBUILD] %d/%d suites PASS' % (len(suites),len(suites)))
