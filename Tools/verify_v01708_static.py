...
suite = CheckSuite("v0.17.0.8 failure-hint identity compaction static verification")
version_txt, version_json, version_cs = parse_version()
suite.equal(version_txt, "0.17.0.8", "VERSION is v0.17.0.8")
...
suite.check("CurrentAlgorithmVersion = 1670" in contracts_code,
