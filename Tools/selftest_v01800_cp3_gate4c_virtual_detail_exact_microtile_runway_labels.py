...
suite=CheckSuite("v0.18.0.0 CP3 Gate 4C Virtual Detail Exact Microtile Runway Labels")
...
ui='UiCheckpoint = "DEV CP3 GATE 4C — VIRTUAL DETAIL / EXACT MICROTILE / RUNWAY END LABELS — COMPILE HOTFIX 1"'
suite.check(ui in version and ui in build,"tab/build identity is Gate 4C")
suite.check('CP3 Gate 4C Virtual Detail / Exact Microtile / Runway End Labels Compile Hotfix 1' in read(ROOT/'GameData/AERISFlightControl/AERISFlightControl.version'),"AVC identity is Gate 4C Compile Hotfix 1")
suite.check('run_v01800_cp3_gate4c_acceptance.py' in build,"build entrypoint invokes current Gate 4C acceptance")
