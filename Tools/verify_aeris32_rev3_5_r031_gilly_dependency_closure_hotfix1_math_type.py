...
('LibNoise.GradientNoiseBasis' in text and 'LibNoise.Math' in text and 'LibNoise.Utils' not in text,'correct LibNoise dependency targets'),
...
print('PASS: R031 Gilly dependency closure Hotfix1 verification')
