...
suite = CheckSuite("v0.17.0.6 canonical source-geometry cache static verification")
version_txt, version_json, version_cs = parse_version()
suite.equal(version_txt, "0.17.0.6", "VERSION is v0.17.0.6")
...
suite.check("CurrentAlgorithmVersion = 1660" in contracts_code,
            "canonical source cache fingerprint has a new algorithm version")
