...
# Hotfix 1 supersedes Gate 3's exact current-version assertion while retaining the
# Gate 3 planner and all successor boundaries as separate evidence.
...
tests = [
    "selftest_v01800_cp3_gate3_terrain_continuity_telemetry_hotfix1.py",
    "selftest_v01800_cp3_gate3_predictive_forward_corridor.py",
...
print("\n[v0.18.0.0 CP3 Gate 3 Terrain Continuity Telemetry Hotfix 1] " +
