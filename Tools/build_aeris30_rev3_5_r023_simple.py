...
PREFIX = '[AERIS30 REV3.5 R023 SIMPLE BUILD]'
...
parser = argparse.ArgumentParser(description=(
    'Simplified AERIS R023 development build. Directly compiles the current C# source '
...
identity = (
    'build_mode=AERIS30_R023_SIMPLIFIED_DEVELOPMENT\n'
