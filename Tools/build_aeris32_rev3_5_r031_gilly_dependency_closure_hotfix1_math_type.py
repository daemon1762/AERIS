...
PREFIX='[AERIS32 R031 GILLY DEP HF1 BUILD]'
...
if not source.is_file() or MARKER not in source.read_text():
 run([sys.executable,ROOT/'Tools/build_aeris32_rev3_5_r031_gilly_dependency_closure_shadow.py',str(ksp)])
...
run([sys.executable,ROOT/'Tools/apply_aeris32_rev3_5_r031_gilly_dependency_closure_hotfix1_math_type.py'])
run([sys.executable,ROOT/'Tools/verify_aeris32_rev3_5_r031_gilly_dependency_closure_hotfix1_math_type.py'])
for p in frozen:
