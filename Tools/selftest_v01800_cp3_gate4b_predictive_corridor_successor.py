...
runner = read(ROOT / "Tools/run_v01800_cp3_gate4b_acceptance.py")
...
suite.check(
            'UiCheckpoint = "DEV CP3 GATE 4B — AERIS TERRAIN TEMPORAL RECONSTRUCTION (ATTR)"' in generated and
            'UiCheckpoint = "DEV CP3 GATE 4B — AERIS TERRAIN TEMPORAL RECONSTRUCTION (ATTR)"' in build,
            "generated/build tab version names Gate 4B")
...
suite.check("selftest_v01800_cp3_gate4b_predictive_corridor_successor.py" in runner,
