...
suite = CheckSuite("v0.17.0.7 sub-metre provider-frame cache static verification")
version_txt, version_json, version_cs = parse_version()
suite.equal(version_txt, "0.17.0.7", "VERSION is v0.17.0.7")
...
for token in ("CurrentSchemaVersion = 5", "PreviousSchemaVersion = 4",
